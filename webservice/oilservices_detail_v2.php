...
//    $shopping_search_url = "http://www.ebay.com/sch/i.html?_nkw=";
    $_keyword = "";
    ...
    $result = array(
        ...
        "shopping_link" => $oil_service->ebay_link,
        "shopping_keywords" => $oil_service->ebay_keywords,
    ...
    if ($oil_service->ebay_link) {
      ...
      $shopping_keywords = $_keyword . " " . str_replace(",", " ", $oil_service->ebay_keywords);
    }
    if ($shopping_keywords) {
      $result['shopping_result'] = get_shopping_search_result($shopping_keywords);
    }
