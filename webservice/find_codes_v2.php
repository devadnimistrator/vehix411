...
class ClaimApi extends Webservice {
  ...
  function run() {
    ...
    if ($this->errorcode == SUCCESS_CODE) {
      $make_name = "";
      $model_name = "";
//      $ebay_search_url = "http://www.amazon.com/sch/i.html?_nkw=";
      $_keyword = "";
      ...
      if ($products && !empty($products)) {
        foreach ($products as $product) {
          ...
          $code_info = array(
              ...
              "shopping_keywords" => $product->ebay_keywords,
          ...
          $shopping_keywords = "";
          if ($product->ebay_keywords) {
            $shopping_keywords = $_keyword . " " . str_replace(",", " ", $product->ebay_keywords);
          } else {
            $shopping_keywords = $_keyword . $search_keywords;
            $code_info['shopping_keywords'] = $shopping_keywords;
          }

          if ($shopping_keywords) {
            $code_info['shopping_result'] = get_shopping_search_result($shopping_keywords);
          }
        ...
        if ($code_exists) {
          ...
          if ($html) {
            ...
            $search_keywords = $this->make_keyword($code_info);
            $shopping_keywords .= $search_keywords;
            $code_info['shopping_keywords'] = $shopping_keywords;
